    ...
    e.addEventListener("click", function () {
      ...
      if (ea.className === "europeAnimation clicked") {
        data.rss.channel.item.forEach(function (element) {
          if (JSON.parse(localStorage.getItem("article")).forEach(function (article) {
            return console.log(article.category);
          })) {
            JSON.parse(localStorage.getItem("article")).forEach(function (article) {
              return console.log(article.category);
            });
